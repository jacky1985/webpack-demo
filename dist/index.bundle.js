...
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__math_js__ = __webpack_require__(3);
...
if (process.env.NODE_ENV !== 'production') {
   console.log(
     __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.join(['开发环境!','asa', 'module', 'loaded!'], ' ')
   );
}
